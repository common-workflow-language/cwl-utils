...
class Graph(Node):
    ...
    def subjects(
        self, predicate: Any | None = ..., object: Any | None = ...
    ) -> Iterable[Node]: ...
    def predicates(
        self, subject: Any | None = ..., object: Any | None = ...
    ) -> Iterable[Node]: ...
    def objects(
    ...
    def transitiveClosure(
        self, func: Any, arg: Any, seen: Any | None = ...
    ) -> Iterator[Any]: ...
    ...
    def load(
        self, source: Any, publicID: Any | None = ..., format: str = ...
    ) -> "Graph": ...
    def query(
        self,
        query_object: Any,
    ...
    def de_skolemize(
        self, new_graph: Any | None = ..., uriref: Any | None = ...
    ) -> Graph: ...
