...
class _Loader(Generic[FieldType], metaclass=ABCMeta):
    @abstractmethod
    def load(
        self,
        doc: Any,
...
@mypyc_attr(native_class=True)
class _PrimitiveLoader(_Loader[FieldType]):
...
@mypyc_attr(native_class=True)
class _ArrayLoader(_Loader[Sequence[FieldType]]):
    def __init__(self, items: _Loader[FieldType]) -> None:
...
@mypyc_attr(native_class=True)
class _MapLoader(_Loader[Mapping[str, FieldType]]):
    def __init__(
        self,
        values: _Loader[FieldType],
        name: str | None = None,
...
@mypyc_attr(native_class=True)
class _EnumLoader(_Loader[EnumFieldType]):
...
@mypyc_attr(native_class=True)
class _SecondaryDSLLoader(_Loader[FieldType]):
    def __init__(self, inner: _Loader[FieldType]) -> None:
...
@mypyc_attr(native_class=True)
class _RecordLoader(_Loader[SaveableType]):
    def __init__(
        self,
...
@mypyc_attr(native_class=True)
class _UnionLoader(_Loader[FieldType]):
    def __init__(self, alternates: Sequence[_Loader[FieldType]], name: str | None = None) -> None:
        self.alternates = alternates
        self.name: Final = name

    def add_loaders(self, loaders: Sequence[_Loader[FieldType]]) -> None:
...
@mypyc_attr(native_class=True)
class _URILoader(_Loader[FieldType]):
    def __init__(
        self,
        inner: _Loader[FieldType],
        scoped_id: bool,
        vocab_term: bool,
        scoped_ref: int | None,
...
@mypyc_attr(native_class=True)
class _TypeDSLLoader(_Loader[FieldType]):
    def __init__(
        self,
        inner: _Loader[FieldType],
        refScope: int | None,
...
class _IdMapLoader(_Loader[FieldType]):
    def __init__(
        self, inner: _Loader[FieldType], mapSubject: str, mapPredicate: str | None
    ) -> None:
        self.inner: Final = inner
...
@mypyc_attr(native_class=True)
class InputEnumSchema(schema_salad.metaschema.EnumSchema):
    name: str
...
@mypyc_attr(native_class=True)
class OutputEnumSchema(schema_salad.metaschema.EnumSchema):
    name: str
...
@mypyc_attr(native_class=True)
class OutputParameter(Saveable):
    id: str
...
@mypyc_attr(native_class=True)
class CommandLineBinding(Saveable):
    """
    ...
    - **File**: Add ``prefix`` and the value of ```File.path`` <#File>`__ to the command line.

    - **Directory**: Add ``prefix`` and the value of ```Directory.path`` <#Directory>`__ to the command line.
...
class CommandLineTool(Saveable):
    ...
    def fromDoc(
        ...
        if "temporaryFailCodes" in _doc:
            try:
                temporaryFailCodes = _load_field(
        ...
        if "permanentFailCodes" in _doc:
            try:
                permanentFailCodes = _load_field(
    ...
    def __init__(
        ...
        id: None | str = None,
        requirements: None | Sequence[DockerRequirement | EnvVarRequirement | InitialWorkDirRequirement | InlineJavascriptRequirement | MultipleInputFeatureRequirement | ResourceRequirement | ScatterFeatureRequirement | SchemaDefRequirement | ShellCommandRequirement | SoftwareRequirement | StepInputExpressionRequirement | SubworkflowFeatureRequirement] = None,
        hints: None | Sequence[Any | DockerRequirement | EnvVarRequirement | InitialWorkDirRequirement | InlineJavascriptRequirement | MultipleInputFeatureRequirement | ResourceRequirement | ScatterFeatureRequirement | SchemaDefRequirement | ShellCommandRequirement | SoftwareRequirement | StepInputExpressionRequirement | SubworkflowFeatureRequirement] = None,
        label: None | str = None,
        doc: None | str = None,
...
class DockerRequirement(Saveable):
    ...
    def fromDoc(
        ...
        if "dockerOutputDirectory" in _doc:
            try:
                dockerOutputDirectory = _load_field(
...
class WorkflowStepInput(Saveable):
    ...
    To merge multiple inbound data links, `MultipleInputFeatureRequirement <#MultipleInputFeatureRequirement>`__ must be specified in the workflow or workflow step requirements.

    If the sink parameter is an array, or named in a `workflow scatter <#WorkflowStep>`__ operation, there may be multiple inbound data links listed in the ``source`` field.  The values from the input links are merged depending on the method specified in the ``linkMerge`` field.  If not specified, the default method is "merge_nested".
...
class WorkflowStep(Saveable):
    ...
    To use scatter/gather, `ScatterFeatureRequirement <#ScatterFeatureRequirement>`__ must be specified in the workflow or workflow step requirements.
    ...
    * **flat_crossproduct** specifies the Cartesian product of the inputs, producing a job for every combination of the scattered inputs.  The output arrays must be flattened to a single level, but otherwise listed in the order that the input arrays are listed in the ``scatter`` field.
    ...
    To specify a nested workflow as part of a workflow step, `SubworkflowFeatureRequirement <#SubworkflowFeatureRequirement>`__ must be specified in the workflow or workflow step requirements.
    ...
    def __init__(
        ...
        run: CommandLineTool | ExpressionTool | Workflow | str,
        requirements: None | Sequence[DockerRequirement | EnvVarRequirement | InitialWorkDirRequirement | InlineJavascriptRequirement | MultipleInputFeatureRequirement | ResourceRequirement | ScatterFeatureRequirement | SchemaDefRequirement | ShellCommandRequirement | SoftwareRequirement | StepInputExpressionRequirement | SubworkflowFeatureRequirement] = None,
...
class Workflow(Saveable):
    ...
    Dependencies between parameters are expressed using the ``source`` field on `workflow step input parameters <#WorkflowStepInput>`__ and `workflow output parameters <#WorkflowOutputParameter>`__.
    ...
    * If all workflow steps are executed and complete with ``success``, then the workflow status is ``success``.
    ...
    `ScatterFeatureRequirement <#ScatterFeatureRequirement>`__ and `SubworkflowFeatureRequirement <#SubworkflowFeatureRequirement>`__ are available as standard `extensions <#Extensions_and_Metadata>`__ to core workflow semantics.
...
"""
RecordFieldLoader: Final[_Loader[schema_salad.metaschema.RecordField]] = _RecordLoader(
    schema_salad.metaschema.RecordField, None, None
)
RecordSchemaLoader: Final[_Loader[schema_salad.metaschema.RecordSchema]] = (
    _RecordLoader(schema_salad.metaschema.RecordSchema, None, None)
)
EnumSchemaLoader: Final[_Loader[schema_salad.metaschema.EnumSchema]] = _RecordLoader(
    schema_salad.metaschema.EnumSchema, None, None
)
ArraySchemaLoader: Final[_Loader[schema_salad.metaschema.ArraySchema]] = _RecordLoader(
    schema_salad.metaschema.ArraySchema, None, None
)
MapSchemaLoader: Final[_Loader[schema_salad.metaschema.MapSchema]] = _RecordLoader(
    schema_salad.metaschema.MapSchema, None, None
)
UnionSchemaLoader: Final[_Loader[schema_salad.metaschema.UnionSchema]] = _RecordLoader(
...
InputParameterLoader: Final[_Loader[InputParameter]] = _RecordLoader(
    InputParameter, None, None
)
OutputParameterLoader: Final[_Loader[OutputParameter]] = _RecordLoader(
...
array_of_RecordFieldLoader: Final[
    _Loader[Sequence[schema_salad.metaschema.RecordField]]
] = _ArrayLoader(RecordFieldLoader)
union_of_None_type_or_array_of_RecordFieldLoader: Final[
    _Loader[None | Sequence[schema_salad.metaschema.RecordField]]
] = _UnionLoader(
    (
        None_type,
...
union_of_None_type_or_inttype_or_longtype: Final[_Loader[None | i32 | i64]] = (
    _UnionLoader(
        (
            None_type,
            inttype,
...
array_of_union_of_strtype_or_ExpressionLoader: Final[_Loader[Sequence[str]]] = (
...
array_of_InputParameterLoader: Final[_Loader[Sequence[InputParameter]]] = _ArrayLoader(
    InputParameterLoader
)
idmap_inputs_array_of_InputParameterLoader: Final[_Loader[Sequence[InputParameter]]] = (
    _IdMapLoader(array_of_InputParameterLoader, "id", "type")
)
array_of_OutputParameterLoader: Final[_Loader[Sequence[OutputParameter]]] = (
    _ArrayLoader(OutputParameterLoader)
)
idmap_outputs_array_of_OutputParameterLoader: Final[
    _Loader[Sequence[OutputParameter]]
...
array_of_union_of_InputRecordSchemaLoader_or_InputEnumSchemaLoader_or_InputArraySchemaLoader: Final[
    _Loader[Sequence[InputArraySchema | InputEnumSchema | InputRecordSchema]]
] = _ArrayLoader(
    union_of_InputRecordSchemaLoader_or_InputEnumSchemaLoader_or_InputArraySchemaLoader
)
...
array_of_union_of_FileLoader_or_DirectoryLoader_or_DirentLoader_or_strtype_or_ExpressionLoader: Final[
    _Loader[Sequence[Directory | Dirent | File | str]]
] = _ArrayLoader(
    union_of_FileLoader_or_DirectoryLoader_or_DirentLoader_or_strtype_or_ExpressionLoader
)
union_of_array_of_union_of_FileLoader_or_DirectoryLoader_or_DirentLoader_or_strtype_or_ExpressionLoader_or_strtype_or_ExpressionLoader: Final[
    _Loader[Sequence[Directory | Dirent | File | str] | str]
] = _UnionLoader(
    (
...
union_of_strtype_or_CommandLineToolLoader_or_ExpressionToolLoader_or_WorkflowLoader: (
    Final[_Loader[CommandLineTool | ExpressionTool | Workflow | str]]
) = _UnionLoader(
    (
        strtype,
...
uri_union_of_strtype_or_CommandLineToolLoader_or_ExpressionToolLoader_or_WorkflowLoader_False_False_None_None: Final[
    _Loader[CommandLineTool | ExpressionTool | Workflow | str]
] = _URILoader(
    union_of_strtype_or_CommandLineToolLoader_or_ExpressionToolLoader_or_WorkflowLoader,
    False,
    False,
...
union_of_CommandLineToolLoader_or_ExpressionToolLoader_or_WorkflowLoader: Final[
    _Loader[CommandLineTool | ExpressionTool | Workflow]
] = _UnionLoader(
    (
        CommandLineToolLoader,
        ExpressionToolLoader,
...
array_of_union_of_CommandLineToolLoader_or_ExpressionToolLoader_or_WorkflowLoader: (
    Final[_Loader[Sequence[CommandLineTool | ExpressionTool | Workflow]]]
) = _ArrayLoader(
    union_of_CommandLineToolLoader_or_ExpressionToolLoader_or_WorkflowLoader
)
union_of_CommandLineToolLoader_or_ExpressionToolLoader_or_WorkflowLoader_or_array_of_union_of_CommandLineToolLoader_or_ExpressionToolLoader_or_WorkflowLoader: Final[
    _Loader[
        CommandLineTool
        | ExpressionTool
        | Sequence[CommandLineTool | ExpressionTool | Workflow]
        | Workflow
    ]
] = _UnionLoader(
    (
...
InputBinding: TypeAlias = CommandLineBinding
OutputBinding: TypeAlias = CommandOutputBinding
...
Process: TypeAlias = CommandLineTool | ExpressionTool | Workflow
Sink: TypeAlias = WorkflowStepInput
SchemaBase: TypeAlias = InputSchema | OutputSchema | Parameter
