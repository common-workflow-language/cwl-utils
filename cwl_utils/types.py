...
DirectoryType = TypedDict(
    "DirectoryType",
    {
        ...
        "path": str,
        "basename": str,
        "listing": MutableSequence["FileType | DirectoryType"],
    },
    total=False,
)
...
FileType = TypedDict(
    "FileType",
    {
        ...
        "checksum": str,
        "size": int,
        "secondaryFiles": MutableSequence["FileType | DirectoryType"],
        "format": str,
        "contents": str,
    },
    total=False,
...
def is_directory(value: Any) -> TypeGuard[DirectoryType]:
...
def is_file(value: Any) -> TypeGuard[FileType]:
...
def is_file_or_directory(
    value: Any,
) -> TypeGuard[FileType | DirectoryType]:
